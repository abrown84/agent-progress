...
import { TOOL_CONFIG } from "../../utils/taskSummary";
...
export const TaskIcon = memo(function TaskIcon({ tool, className }: TaskIconProps) {
  const iconType = TOOL_CONFIG[tool]?.icon || "info";
  return <span className={className}>{ICONS[iconType] || ICONS.info}</span>;
});
